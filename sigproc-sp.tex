...
\subsubsection{Localization}~\label{sec:localization}
 ...
 Submitters can change the location information suggested by the application later. Also, for outdoor scenario, 
...
%==========
\section{Test}
We developed and tested our Android application on Google Nexus S with 4.1.2 SDK. \framedots
...
\item
Rewrite public site into Single-page application.
\end{itemize}
% That's all folks!
\end{document}
