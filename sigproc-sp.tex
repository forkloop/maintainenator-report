...
We programmed our application\footnote{\url{https://github.com/forkloop/Maintain-e-nator}} on the Android~\cite{android} platform.
...
\begin{inparaenum}
 ...
 The application won't try to remember how the submitter logged in last time and use it for next time, each time submitter can choose whatever manner she wants.
...
we host our web application code on \texttt{heroku}~\footnote{\url{https://www.heroku.com/}}, which is a
...
as our frontend MVC. So when user first open this public site, it start to render a page and fetch the required data asynchronously from web application RESTful
